...
public class NewsFragTwo extends Fragment {
    ...
    public static NewsFragTwo getInstance(){
        return new NewsFragTwo();
    }
    ...
    private void initView(View view) {
        ...
        SinaRefreshView headView = new SinaRefreshView(mContext);
