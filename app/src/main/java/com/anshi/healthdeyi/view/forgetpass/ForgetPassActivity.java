package com.anshi.healthdeyi.view.forgetpass;
...
public class ForgetPassActivity extends BaseActivity implements View.OnClickListener{
        ...
        public void handleMessage(Message msg) {
            switch (msg.arg1) {
                case 0:
                    ...
                    try {
                         updatePass(mPhoneEdit.getText().toString(),mPassEdit.getText().toString());
                    }catch (Exception e){
                        e.printStackTrace();
                    }
                ...
                case 1:
                    //获取验证码成功
                    ToastUtils.showShortToast(mContext,getString(R.string.forget_has_verify_success));
                    break;
                case 2:
                    //返回支持发送验证码的国家列表
                    ...
                    break;
                case 3:
                    ToastUtils.showShortToast(mContext,getString(R.string.forget_verify_fail));
                    break;
    ...
    private void initView() {
        mToolBarText = (TextView) findViewById(R.id.register_title);
        mToolBarText.setText("修改密码");
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.has_verify_rb:
                ...
                if(phone.equals("")){
                    ToastUtils.showShortToast(mContext,getString(R.string.phone_is_not_empty));
                    return;
                }else{
                    //填写了手机号码
                    if(CallUtil.isMobileNO(phone)){
                        ...
                        //手机号格式有误
                        ToastUtils.showShortToast(mContext,getString(R.string.phone_is_wrong));
                    }
                }
                break;
...
* */
    ...
    //修改会员密码
    private void updatePass(String phone,String pass){
        final KProgressHUD commonLoadDialog = DialogBuild.getBuild().createCommonLoadDialog(this, "正在修改密码...");
        ...
        final Request request = new Request.Builder()
                .url(Constants.COMMON_HEADER+Constants.FORGET_PASS)
                .post(requestBody)
                .build();
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                if (registerEntry.isCode()){
                                    ToastUtils.showShortToast(mContext,"修改成功");
