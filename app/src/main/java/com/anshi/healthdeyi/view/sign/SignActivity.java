package com.anshi.healthdeyi.view.sign;
...
//        });
    ...
    private void initMarkData() {
        ...
        markData.put("2018-4-5", "1");
        markData.put("2018-4-6", "1");
        markData.put("2018-4-7", "1");
        markData.put("2018-10-11", "1");
    ...
    private void refreshMonthPager() {
        ...
        tvMonth.setText(today.getMonth() + "月");
    }
    ...
    public void signSuccess(View view) {
        ...
        int i = cal.get(java.util.Calendar.DAY_OF_MONTH);
        Log.e("xxx", i + "\t" + currentDate.getDay());
        //当前月
        int month = (cal.get(java.util.Calendar.MONTH)) + 1;
        //String selectDate = currentDate.getYear() + "-" + currentDate.getMonth() + "-" + currentDate.getDay();
        if (currentDate.getMonth() != month) {
            Toast.makeText(context, "只支持本月的补签", Toast.LENGTH_SHORT).show();
            return;
        }
        if (currentDate.getDay() > cal.get(java.util.Calendar.DAY_OF_MONTH)) {
            Toast.makeText(context, "时间还没到呢...", Toast.LENGTH_SHORT).show();
            return;
        }
        if (!currentDate.isSign()) {
            Toast.makeText(context, "签到成功", Toast.LENGTH_SHORT).show();
        } else {
            ToastUtils.showShortToast(context, "你已经签过到了");
        }
